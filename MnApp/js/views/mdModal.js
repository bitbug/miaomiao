    ...
    MDModal.prototype = {
        ...
        setHeight: function() {
            ...
            nextEventLoop(function() {
                ...
                theContainer.css('height', containerHeight + 60);
        ...
        removeEvents: function() {
            ...
            var events = [{
                ...
                eventType: 'click.ch-moModal-okay',
                targetElm: 'body'
            }];

            events.forEach(function(obj, index) {
                $(obj.targetElm).off(obj.eventType);
            });
        },
        bindEvents: function() {
            var _this = this;
            ...
            $('body').on('click.ch-moModal-okay', '.ch-okay', function() {
                _this.view.$el.trigger('mdModalOkay');
                //_this.hide();
            });
            ...
            $('body').on('webkitAnimationEnd.ch-modal-animate mozAnimationEnd.ch-modal-animate MSAnimationEnd.ch-modal-animate oanimationend.ch-modal-animate animationend.ch-modal-animate', '.ch-container-mdModal.fadeOutUp', function() {
                ...
                _this.removeHeight();
                _this.removeEvents();
                _this.view.$el.trigger('mdModalClose');
                setTimeout(function() {
                    _this.dump();
                }, 0);
            });
