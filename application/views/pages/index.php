...
<!-- <link href='http://fonts.googleapis.com/css?family=Roboto:400,900,300|Oswald:400,300,700' rel='stylesheet' type='text/css'> -->
        ...
        <link rel="stylesheet" type="text/css" href="App/css/bootstrap-3.2.0/css/bootstrap.min.css">
        
        <link rel="stylesheet" type="text/css" href="App/css/viper.css">
        <link rel="stylesheet" type="text/css" href="App/css/bootstrapOverrides.css">
        <link rel="stylesheet" type="text/css" href="App/css/font-awesome.css">
        <link rel="stylesheet" type="text/css" href="App/css/animate.css">
        <link rel="stylesheet" type="text/css" href="App/css/equipment-management.css">
    ...
    <body>
        <div id="container-equipmentManagement">
